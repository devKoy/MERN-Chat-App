    ...
    <div className="bg-blue-50 h-screen flex items-center">
      ...
      <form className="w-64 mx-auto mb-12" onSubmit={handleSubmit}>
        <div className="flex flex-col w-full items-center p-5">
          ...
          <span className="font-bold text-sky-400 text-xl">Chatify</span>
        </div>
        ...
        <div className="text-center mt-2">
          {isLoginOrRegister === 'register' && (
            <div>
              ...
              <button className="ml-1 text-sky-500" onClick={() => setIsLoginOrRegister('login')}>
                Login here
              </button>
            </div>
          )}
          {isLoginOrRegister === 'login' && (
            <div>
              ...
              <button className="ml-1 text-sky-500" onClick={() => setIsLoginOrRegister('register')}>
                Register
              </button>
            </div>
          )}
